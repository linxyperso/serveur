...
class Life_Settings {
    ...
    impound_air = 6500; //Price for impounding helicopters / planes

    /* Initial Bank Amount */
    bank_cop = 15000; //Amount of cash on bank for new cops
    bank_civ = 10000; //Amount of cash on bank for new civillians
    bank_med = 17500; //Amount of cash on bank for new medics

    /* Paycheck Amount */
    paycheck_cop = 2700; //Payment for cops
    paycheck_civ = 1100; //Payment for civillians
    paycheck_med = 2300; //Payment for medics
