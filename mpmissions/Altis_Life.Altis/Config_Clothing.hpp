...
class Clothing {
    ...
    class cop {
        ...
        uniforms[] = {
            ...
            { "U_Rangemaster", "Polo Gendarme", 750, { "", "", -1 } },
            { "U_B_CombatUniform_mcam", "", 3500, { "life_coplevel", "SCALAR", 3 } },
            { "U_MillerBody", "", 12500, { "life_coplevel", "SCALAR", 7 } },
            { "U_BG_Guerilla2_1", "", 3500, { "life_coplevel", "SCALAR", 5 } },
            { "U_B_FullGhillie_lsh", "", 3500, { "life_coplevel", "SCALAR", 5 } },
            { "U_B_Wetsuit", "", 3500, { "life_coplevel", "SCALAR", 5 } }
        };
        headgear[] = {
            { "NONE", "Retirer Chapeau", 0, { "", "", -1 } },
            { "H_Cap_police", "", 75, { "life_coplevel", "SCALAR", 1 } },
            { "H_MilCap_ocamo", "", 120, { "life_coplevel", "SCALAR", 2 } },
            { "H_Beret_blk_POLICE", "", 100, { "life_coplevel", "SCALAR", 4 } },
            { "H_Beret_02", "", 100, { "life_coplevel", "SCALAR", 5 } },
            { "H_Beret_Colonel", "", 100, { "life_coplevel", "SCALAR", 7 } },
			{ "H_Watchcap_blk", "", 100, { "life_coplevel", "SCALAR", 7 } },
			{ "H_HelmetB_camo", "", 100, { "life_coplevel", "SCALAR", 7 } },
			{ "H_CrewHelmetHeli_B", "", 100, { "life_coplevel", "SCALAR", 7 } }
        };
        goggles[] = {
            { "NONE", "Retirer Lunette", 0, { "", "", -1 } },
            { "G_Shades_Black", "", 25, { "", "", -1 } },
            { "G_Shades_Blue", "", 20, { "", "", -1 } },
            { "G_Sport_Blackred", "", 20, { "", "", -1 } },
            { "G_Sport_Checkered", "", 20, { "", "", -1 } },
        ...
        vests[] = {
            ...
            { "V_PlateCarrierIAGL_dgtl", "", 1500, { "life_coplevel", "SCALAR", 3 } },
            { "V_PlateCarrier1_blk", "", 1500, { "life_coplevel", "SCALAR", 5 } },
            { "V_PlateCarrierGL_blk", "", 1500, { "life_coplevel", "SCALAR", 7 } },
    ...
    class reb {
        ...
        uniforms[] = {
            ...
            { "TRYK_U_B_WDL_GRY_CombatUniform", "", 5000, { "", "", -1 } },
            { "TRYK_B_TRYK_UCP_T", "", 5000, { "", "", -1 } },
            { "TRYK_ZARATAKI", "", 5000, { "", "", -1 } },
            { "TRYK_ZARATAKI2", "", 5000, { "", "", -1 } },
